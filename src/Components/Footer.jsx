        ...
        <div class="container py-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Powai,Mumbai, Maharashtra, India</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 9372612783</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>bhagwatibashyal1234@gmail.com</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy;2023  <Link class="border-bottom" to="/"> Edu WISE</Link><br/><br/>
